...
const MORNING_MOTIVATION_PROMPT = [
  ...
  "Используй разговорный сленг и крепкие выражения.",
  "Напиши короткую утреннюю сильную мотивацию для модераторов Telegram-бота знакомств.",
  "Контекст: они каждый день проверяют анкеты пользователей.",
  "Сообщение должно состоять из 4-6 строк."
].join(" ");
